...
#### Каждый пост можно открыть в отдельной странице, там же будут видны все (только принятые) комментарии к нему. Если пользователь - автор некоторых комментариев, то возле каждого такого комментария есть кнопки "Edit" и "Delete", чтобы редактировать или удалить комментарий. ####
